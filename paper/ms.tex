...
H_{\d}      &= 905.9 \pm 1.9   \\ % Interim result. Check gave 903.3 +- 10.9
H_{\tau,\d} &= 902.2 \pm 1.7      % Interim result only
\end{align}
...
$I_{\tau, \d} = 11.1 \pm 1.1$ nats {\todo (interim result only)}.
...
The results for the uneven observing schedule are
\begin{align}
I_{\x, \d} &= 12.09 \pm 0.82
\end{align}
