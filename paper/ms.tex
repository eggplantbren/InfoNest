...
of $\pm 5$. Any of the following statements would resolve the issue:
\begin{itemize}
\item $\x \in \{1, ..., 11\}$ and anything that implies it
\item $\x \in \{2, ..., 12\}$ and anything that implies it
\item $\x \in \{3, ..., 13\}$ and anything that implies it\\
...
\item $\x \in \{999,999,990, ..., 1,000,000,000\}$ and anything that implies it.
\end{itemize}
