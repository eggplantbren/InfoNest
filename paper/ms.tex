...
below $\ell$ has expected value $-\ln X(\ell)$, is the basis of the algorithm.
...
The idea is to generate a reference particle $\x_{\rm ref}$
...
towards $\x_{\rm ref}$ in order to measure the log-probability near
$\x_{\rm ref}$.
