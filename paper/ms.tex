...
using Markov Chain Monte Carlo (MCMC). This is often the case when we are
interested in a marginal distribution or conditional distribution.
With minor modifications,
Kullback-Leibler divergences can also be obtained.
