...
Written them in terms of parameters $\boldsymbol{\theta}$ and data
$d$, for Bayesian purposes.

\begin{enumerate}
\item<2-> Entropy of the prior for the parameters $H(\boldsymbol{\theta})$
\item<3-> Entropy of the conditional prior for the data $H(\boldsymbol{\theta} | d)$
\item<4-> Entropy of the posterior $H(\boldsymbol{\theta} | d)$
