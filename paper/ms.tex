...
% on commit 947317948d04255ea0baff7a7d3e357b0c2f7fcb
% With 10 particles, 1000 mcmc steps per NS iteration.

\begin{align}                    % (num_particles, mcmc_steps, max_depth, reps)
H_{\x}    &= 7.328 \pm 0.025 \\% (100, 1000, 30.0,  122)
H_{\d}    &= 960.4 \pm 3.7   \\% (100, 1000, 1200.0, 99)
H_{\x,\d} &= 968.6 \pm 3.4   \\% (100, 1000, 1200.0, 99)
\end{align}
