...
\begin{align}
H'_{\tau}     &=  0.001 \pm 0.025 \label{eqn:h_tau}\\
H'_{\d}       &= -77.12 \pm 0.32   \\
H'_{\tau, \d} &= -82.79 \pm 0.31   \label{eqn:h_joint}
\end{align}
The mutual information is equal to $H_{\tau} + H_{\d} - H_{\tau, \d}$,
