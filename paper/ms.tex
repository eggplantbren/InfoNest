...
% on commit 25301bb
% With 10 particles, 1000 mcmc steps per NS iteration, and 1000 reps.

\begin{align}
H_{\x}     &= 7.345  \pm 0.027 \\  % max depth was 30
H_{\d}     &= 703.96 \pm 0.31  \\  % max depth was 1000
H_{\x, \d} &= 712.27 \pm 0.31      % max depth was 1000
\end{align}
...
Converting these to differential entropies, we obtain
\begin{align}
H'_{\x}     &= 1.131  \pm 0.027 \\  % max depth was 30
H'_{\d}     &= 697.75 \pm 0.31  \\  % max depth was 1000
H'_{\x, \d} &= 699.84 \pm 0.31      % max depth was 1000
\end{align}
