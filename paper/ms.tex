...
$n=101$ measurements. The `even' strategy has us observe at times
\begin{align}
t_i = \frac{i-1}{n-1}
\end{align}
...
\end{align}
which schedules observations close together initially, and the
spacing increases with time.
...
noise level, and the period is between 0.1 and 1 times the observation
interval.
